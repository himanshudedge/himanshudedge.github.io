...
History:
Fixed for Jekyl 1.4.x  (T Mackinnon - 2014/02/26)
https://gist.github.com/macta/9230984

Fixed for Jekyl 1.3.x (Rune Madsen - 2013)
https://gist.github.com/runemadsen/6263974

Orginal Work (Keith Marran)
https://github.com/macta/marran.com/tree/master/_plugins
  ...
  class CategoryPages < Generator
    ...
    def paginate(site, page)
      ...
      (1..pages).each do |num_page|
        ...
        pager = CategoryPager.new(page.data['category'], site.config, num_page, category_posts, page_dir+'/', '/'+dir, pages)
